 ...
 */
    ...
    $result = $uploader->handleDelete("../../../procesos/folios/".$_SESSION['carpeta']."/");
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../../procesos/folios/".$_SESSION['carpeta']."/");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../../procesos/folios/".$_SESSION['carpeta']."/");
