    ...
    <body>    
        <div id="container">
            <div id="emisor"> 
                ...
                <b>'.strtoupper(substr($Documento->getElementsByTagName("GiroEmis")->item(0)->nodeValue,0,80)).'</b><br>
                '.strtoupper(substr($Documento->getElementsByTagName("DirOrigen")->item(0)->nodeValue,0,49)).'&nbsp;,&nbsp;'
                ...
                <table id="tablaValores">';     
                    $DctoRecs = $Documento->getElementsByTagName("DscRcgGlobal");
                        ...
                        foreach($DctoRecs as $DctoRec) 
                        {
                            ...
                            {
                                $tipoMov = "Descuento";
                                if(($DctoRec->getElementsByTagName("TpoValor")->item(0)->nodeValue) == "%")
                                {
                                    $descPorc =  $descPorc + $DctoRec->getElementsByTagName("ValorDR")->item(0)->nodeValue;
                                }
                                else
                                {
                                    $descMonto =  $descMonto + $DctoRec->getElementsByTagName("ValorDR")->item(0)->nodeValue;
                                }
                            }
                            else if(($DctoRec->getElementsByTagName("TpoMov")->item(0)->nodeValue) == "R")
                            {
                                ...
                                if(($DctoRec->getElementsByTagName("TpoValor")->item(0)->nodeValue) == "%")
                                {
                                    $recPorc =  $recPorc + $DctoRec->getElementsByTagName("ValorDR")->item(0)->nodeValue;
                                }
                                else
                                {
                                    $recMonto =  $recMonto + $DctoRec->getElementsByTagName("ValorDR")->item(0)->nodeValue;
                                }
                            }
                        }
                        if($descPorc > 0)
                        {
                            $content.='<tr><td style=" padding-right: 10px; width: 50px">Descuento&nbsp;%</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.$descPorc.'</td></tr>';
                        }
                        if($descMonto > 0)
                        {
                            $content.='<tr><td style=" padding-right: 10px; width: 50px">Descuento&nbsp;$</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.$descMonto.'</td></tr>';
                        }
                        if($recPorc > 0)
                        {
                            $content.='<tr><td style=" padding-right: 10px; width: 50px">Recargo&nbsp;%</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.$recPorc.'</td></tr>';
                        }
                        if($recMonto > 0)
                        {
                            $content.='<tr><td style=" padding-right: 10px; width: 50px">Recargo&nbsp;$</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.$recMonto.'</td></tr>';
                        }

                        $content.='</table><br><table id="tablaValores"><tr>
                        ...
                        <tr>
                            <td style=" padding-right: 10px; width: 50px;">Moneda</td><td style="padding-left: 10px; text-align: right; width: 63px; background-color: #ececec;">'.$Documento->getElementsByTagName("TpoMoneda")->item(0)->nodeValue.'</td>
                        </tr>
                        <tr>
                            <td style=" padding-right: 10px; width: 50px">Exento $</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.number_format($Documento->getElementsByTagName("MntExe")->item(0)->nodeValue,2,".",",").'</td>
                        </tr>
                        <tr>
                            <td style=" padding-right: 10px; width: 50px">Total $</td><td style="padding-left: 10px;  text-align: right; width: 63px; background-color: #ececec;">'.number_format($Documento->getElementsByTagName("MntTotal")->item(0)->nodeValue,2,".",",").'</td>
                        </tr>
                        <tr>
                            <td style=" padding-right: 10px; width: 50px">Total CLP $</td><td style="padding-left: 10px; text-align: right; width: 63px; background-color: #ececec;">'.number_format($Documento->getElementsByTagName("MntTotOtrMnda")->item(0)->nodeValue,2,".",",").'</td>
                        </tr>
                    </table>
                </td> </tr> </table>
            </div>';
